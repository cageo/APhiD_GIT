...
!======================================================================!
      ...
      real(dp), dimension(1:nx-1) :: coef_2vec,coef_3vec
      real(dp), dimension(1:ny)   :: coef_4vec,coef_5vec
      real(dp), dimension(1:nz)   :: coef_6vec,coef_7vec
 
      integer, dimension(1:nx-1) :: ia_vec,ib_vec
      integer, dimension(1:ny)   :: ja_vec,jb_vec
      integer, dimension(1:nz)   :: ka_vec,kb_vec
...
!======================================================================!
      ...
      real(dp), dimension(1:ny-1) :: coef_2vec,coef_3vec
      real(dp), dimension(1:nx)   :: coef_4vec,coef_5vec
      real(dp), dimension(1:nz)   :: coef_6vec,coef_7vec
 
      integer, dimension(1:nx)     :: ia_vec,ib_vec
      integer, dimension(1:ny-1)   :: ja_vec,jb_vec
      integer, dimension(1:nz)     :: ka_vec,kb_vec
...
!======================================================================!
      ...
      real(dp), dimension(1:nz-1) :: coef_2vec,coef_3vec
      real(dp), dimension(1:nx)   :: coef_4vec,coef_5vec
      real(dp), dimension(1:ny)   :: coef_6vec,coef_7vec
 
      integer, dimension(1:nx)     :: ia_vec,ib_vec
      integer, dimension(1:ny)     :: ja_vec,jb_vec
      integer, dimension(1:nz-1)   :: ka_vec,kb_vec
...
!======================================================================!
      ...
      real(dp), dimension(2:nx-1) :: coef_2vec,coef_3vec
      real(dp), dimension(2:ny-1) :: coef_4vec,coef_5vec
      real(dp), dimension(2:nz-1) :: coef_6vec,coef_7vec
 
      integer, dimension(2:nx-1)   :: ia_vec,ib_vec,ic_vec
      integer, dimension(2:ny-1)   :: ja_vec,jb_vec,jc_vec
      integer, dimension(2:nz-1)   :: ka_vec,kb_vec,kc_vec
